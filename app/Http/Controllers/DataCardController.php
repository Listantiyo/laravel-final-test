...
class DataCardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('datacard.index', compact('data'));
    }
    ...
    public function create()
    {
        ...
        // dd($data);
        return view('datacard.tambah', compact('data'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, $cardlist)
    {
        ...
        $cardlist = CardList::find($cardlist);
    ...
    public function addtype(Request $request)
    {
        ...
        return redirect(route('cardlist.create'));
    }
